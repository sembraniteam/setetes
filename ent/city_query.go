...
func (_q *CityQuery) QueryProvince() *ProvinceQuery {
	query := (&ProvinceClient{config: _q.config}).Query()
...
func (_q *CityQuery) QueryDistrict() *DistrictQuery {
...
func (_q *CityQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *CityQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *CityQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *CityQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *CityQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *CityQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CityQuery) Clone() *CityQuery {
	...
	return &CityQuery{
		...
		withProvince: _q.withProvince.Clone(),
...
func (_q *CityQuery) WithProvince(opts ...func(*ProvinceQuery)) *CityQuery {
	query := (&ProvinceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withProvince = query
	return _q
}
...
func (_q *CityQuery) WithDistrict(opts ...func(*DistrictQuery)) *CityQuery {
	query := (&DistrictClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
