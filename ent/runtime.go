...
import (
	...
	"github.com/megalodev/setetes/ent/schema"
...
func init() {
	...
	// blood.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	blood.DefaultUpdatedAt = bloodDescUpdatedAt.Default.(int64)
	...
	// bloodDescID is the schema descriptor for id field.
	bloodDescID := bloodMixinFields0[0].Descriptor()
	// blood.DefaultID holds the default value on creation for the id field.
	blood.DefaultID = bloodDescID.Default.(func() uuid.UUID)
	...
	city.DefaultUpdatedAt = cityDescUpdatedAt.Default.(int64)
	...
	district.DefaultUpdatedAt = districtDescUpdatedAt.Default.(int64)
	...
	// pmilocation.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	pmilocation.DefaultUpdatedAt = pmilocationDescUpdatedAt.Default.(int64)
	...
	// pmilocationDescID is the schema descriptor for id field.
	pmilocationDescID := pmilocationMixinFields0[0].Descriptor()
	// pmilocation.DefaultID holds the default value on creation for the id field.
	pmilocation.DefaultID = pmilocationDescID.Default.(func() uuid.UUID)
	...
	password.DefaultUpdatedAt = passwordDescUpdatedAt.Default.(int64)
	...
	province.DefaultUpdatedAt = provinceDescUpdatedAt.Default.(int64)
	...
	// subdistrict.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	subdistrict.DefaultUpdatedAt = subdistrictDescUpdatedAt.Default.(int64)
	...
	// subdistrictDescID is the schema descriptor for id field.
	subdistrictDescID := subdistrictMixinFields0[0].Descriptor()
	// subdistrict.DefaultID holds the default value on creation for the id field.
	subdistrict.DefaultID = subdistrictDescID.Default.(func() uuid.UUID)
}
