...
func (_q *PasswordQuery) QueryAccount() *AccountQuery {
...
func (_q *PasswordQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *PasswordQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *PasswordQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *PasswordQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *PasswordQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *PasswordQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PasswordQuery) WithAccount(opts ...func(*AccountQuery)) *PasswordQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *PasswordQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Password, error) {
	...
	if query := _q.withAccount; query != nil {
		if err := _q.loadAccount(ctx, query, nodes, nil,
			func(n *Password, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PasswordQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Password, init func(*Password), assign func(*Password, *Account)) error {
