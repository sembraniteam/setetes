...
import (
	...
	"github.com/megalodev/setetes/ent"
)
...
// function as PMILocation mutator.
type PMILocationFunc func(context.Context, *ent.PMILocationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PMILocationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PMILocationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PMILocationMutation", m)
}
...
func (f SubdistrictFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SubdistrictMutation); ok {
		return f(ctx, mv)
	}
