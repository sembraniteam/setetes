...
func (_q *OTPQuery) QueryAccount() *AccountQuery {
...
func (_q *OTPQuery) WithAccount(opts ...func(*AccountQuery)) *OTPQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *OTPQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OTP, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, otp.ForeignKeys...)
	}
	...
	if query := _q.withAccount; query != nil {
		if err := _q.loadAccount(ctx, query, nodes, nil,
			func(n *OTP, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *OTPQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*OTP, init func(*OTP), assign func(*OTP, *Account)) error {
